"""
Django settings for librery project.
...
SECRET_KEY = 'django-insecure-bz5gu__#o*d%in$%+iot#kl@pe&j_qo4a1m9dlvkmpf&x4_=8l'
...
WSGI_APPLICATION = 'librery.wsgi.application'
